      ...
      .then(async (querySnapshot) => {
        ...
        querySnapshot.docs.map((doc) => {
          ...
          if (data.duration !== null) {
            totalPercentage +=
              (data.correct.length / data.questions.length) * 100;
        ...
        <main>
          ...
          <div className="history-sections">
            <div className="historical-user-stats-container">
              ...
              <div className="stat-row stat-row--inline">
                <h1>{`${(this.state.totalCompleteTests > 0
                  ? this.state.totalPercentage / this.state.totalCompleteTests
                  : 0
                ).toFixed(2)}%`}</h1>
                <p>average</p>
              </div>
            ...
            {this.state.userMarkHistory &&
              this.state.userMarkHistory.length > 1 && (
                <LineChart
                  data={this.state.userMarkHistory}
                  sets={this.state.userSetHistory}
                />
              )}
                ...
                {this.state.progressHistoryIncomplete.length > 0 && (
                  <>
                    ...
                    <div className="progress-history-container progress-history-container--incomplete">
                      ...
                      {this.state.progressHistoryIncomplete.map(
                        (progressItem) => (
                ...
                {this.state.progressHistoryComplete.length > 0 && (
                  <>
                    ...
                    <div className="progress-history-container progress-history-container--complete">
                      ...
                      {this.state.progressHistoryComplete.map(
                        (progressItem) => (
                          <div key={progressItem.id}>
                            <Link to={`/progress/${progressItem.id}`}>
                              {progressItem.setTitle}
