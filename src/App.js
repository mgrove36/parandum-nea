...
appCheck.activate("6LfxoQAcAAAAACEuhx1aaBl69svfRDDlq9Md96we", true);
  ...
  updateCookieNoticeMargins = () => {
    if (this.cookieNoticeHeight !== this.cookieNotice.offsetHeight) {
      ...
      this.root.animate(
        {
          marginBottom: [
            `${this.root.marginBottom}px`,
            `${this.cookieNoticeHeight}px`,
          ],
        },
        {
          duration: 500,
      ...
      <div className={this.state.theme}>
        <Router>
                ...
                <Switch>
                  ...
                  <Route path="/settings">
                    <Settings
                      db={db}
                      user={this.state.user}
                      coloredEdges={this.state.coloredEdges}
                      handleColoredEdgesChange={this.handleColoredEdgesChange}
          ...
          <div className="cookie-notice" id="cookie-notice">
            <div>
              <p>
                Just so you know, we use cookies. Read our privacy policy{" "}
        ...
        <Fade
          out={!this.state.pageLoading && this.state.userDataPresent}
