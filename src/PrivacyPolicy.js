  ...
  return (
    <div>
      ...
      <main>
        ...
        <p>
          The Parandum Team (Matthew Grove) ("we" or "us" or "our") respects the
          privacy of our users ("user" or "you"). This Privacy Policy explains
          how we collect, use, disclose, and safeguard your information when you
          visit our website parandum.mgrove.uk, including any other media form,
        ...
        <p>
          ...
          various activities related to the Site. You are under no obligation to
        ...
        <p>
          User information from social networking sites, such as Google and
          Microsoft, including your name, your social network username,
        ...
        <p>
          ...
          of communications, you may turn them off in your device&rsquo;s
          settings.
        </p>
        ...
        <p>
          ...
          exchanging information with other entities for fraud protection.
        </p>
        ...
        <p>
          When you post content to the Site, the content may be viewed by all
        ...
        <p>
          ...
          include our parent companies and any subsidiaries, joint venture
        ...
        <p>
          ...
          modifying your web browser&rsquo;s settings to notify you each time a
          cookie is tendered, permitting you to accept or decline cookies on an
          individual basis.
        </p>
        ...
        <p>
          ...
          cookies, to, among other things, analyze and track users&rsquo; use of
          the Site, determine the popularity of certain content and better
          ...
          information to these third-party vendors. However, if you do not want
          any information to be collected and used by tracking technologies, you
          can visit the third-party vendor or the{" "}
          <a href="http://www.networkadvertising.org/choices/">
            Network Advertising Initiative Opt-Out Tool
          </a>{" "}
          or{" "}
        ...
        <p>
          ...
          altering your browser&rsquo;s cookies files may also clear certain
        ...
        <p>
          We do not knowingly solicit marketing information from or market to
          children under the age of 13. If you become aware of any such data we
          have collected from children under age 13, please contact us using the
        ...
        <p>
          ...
          data about your online browsing activities monitored and collected. If
          you set the DNT signal on your browser, we may respond to such DNT
          browser signals.
        </p>
        ...
        <p>
          ...
          delete your account and personal information from our active
        ...
        <p>
          ...
          servers in order to display advertisements that are most likely to be
          of interest to you. These cookies allow advertisers and ad servers to
          gather information about your visits to the Site and other websites,
          alternate the ads sent to a specific computer, and track how often an
          ad has been viewed and by whom. These cookies are linked to a computer
        ...
        <p>
          ...
          know what features on the Site are working the best and what features
          on the Site can be improved.
        </p>
        ...
        <p>
          ...
          temporary. These are necessary cookies, without some of which the Site
        ...
        <p>
          ...
          you have visited, and your settings and preferences each time you
          visit the Site.
        </p>
        ...
        <p>
          Site management cookies are used to maintain your identity or session
          on the Site so that you are not logged off unexpectedly, and any
        ...
        <p>
          ...
          contact us at{" "}
          <a href="mailto:parandum@mgrove.uk">parandum@mgrove.uk</a>
        </p>
      </main>
      <Footer />
    </div>
