        ...
        await Promise.all(
          querySnapshot.docs.map((userGroupDoc) => {
            return this.state.db
              ...
              .get()
              .then((groupDoc) => {
                if (userGroupDoc.data() && groupDoc.data())
                  newState.userGroups[userGroupDoc.id] = {
              ...
              <>
                <div className="user-groups-list">
                  {Object.keys(this.state.userGroups)
                    .sort((a, b) => {
                      if (
                        this.state.userGroups[a].displayName <
                        this.state.userGroups[b].displayName
                      ) {
                        return -1;
                      }
                      if (
            ...
            this.state.joinGroup && (
              <>
                ...
                <div className="overlay-content user-groups-overlay-content">
                  ...
                  {!this.state.canFindGroup && <p>Can't find that group!</p>}
